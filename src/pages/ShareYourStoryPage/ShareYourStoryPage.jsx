...
const ShareYourStoryPage = ({ contentList }) => {
  ...
  const submitStory = async (data1) => {
    ...
    Object.keys(data1).forEach((key) => {
      return formData.append(`${key}`, data1[key]);
    });
    try {
    ...
    <>
      ...
      <section className="upload">
        ...
        <p className="upload__subheading">
          ...
          personal achievement, or a story that warmed your heart, we want to
          hear it. Share your positive story and help us build a community full
          of hope, joy, and inspiration.{" "}
        </p>
